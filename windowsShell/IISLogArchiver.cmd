...
SetLocal
Set SQLServerName=110Consulting7
...
LogParser.exe -i:IISw3c "Select Date As [RequestDate],Time As [RequestTimeInUTC],s-ip As [ServerLogsGeneratedOn],cs-method As [RequestActionType],cs-uri-stem As [ActionTarget],cs-uri-query As [RequestQuery],s-port As [ServerPortUsed],cs-username As ClientUserName,c-ip As [ClientIPAddress],cs(User-Agent) As [ClientBrowserType],sc-status As [HTTPorFTPStatusCode],sc-substatus As [HTTPorFTPSubStatusCode],sc-win32-status As [WindowsStatusCode],time-taken As [RequestDurationInMilliseconds],cs(Referer) As [PreviousSite],TO_LOCALTIME(SYSTEM_TIMESTAMP()) Into IISLog_110Consulting6 From %GeneralLogPath%W3SVC1\u_ex*.log" -o:SQL -oConnString:"%SQLDBConnectionString%" -Recurse:-1 

echo ============== End: Archive logs in W3SVC1 folder =======================

echo ============== Start: Archive logs in W3SVC2 folder =======================

LogParser.exe -i:IISw3c "Select Date As [RequestDate],Time As [RequestTimeInUTC],s-ip As [ServerLogsGeneratedOn],cs-method As [RequestActionType],cs-uri-stem As [ActionTarget],cs-uri-query As [RequestQuery],s-port As [ServerPortUsed],cs-username As ClientUserName,c-ip As [ClientIPAddress],cs(User-Agent) As [ClientBrowserType],sc-status As [HTTPorFTPStatusCode],sc-substatus As [HTTPorFTPSubStatusCode],sc-win32-status As [WindowsStatusCode],time-taken As [RequestDurationInMilliseconds],cs(Referer) As [PreviousSite],TO_LOCALTIME(SYSTEM_TIMESTAMP()) Into IISLog_110Consulting6 From C:\inetpub\logs\LogFiles\W3SVC2\u_ex*.log" -o:SQL -oConnString:"Driver={SQL Server};Server=110Consulting7;Database=IISLog;Trusted_Connection=yes;" -Recurse:-1 

echo ============== End: Archive logs in W3SVC2 folder =======================

echo ============== Start: Archive logs in W3SVC3 folder =======================

LogParser.exe -i:IISw3c "Select Date As [RequestDate],Time As [RequestTimeInUTC],s-ip As [ServerLogsGeneratedOn],cs-method As [RequestActionType],cs-uri-stem As [ActionTarget],cs-uri-query As [RequestQuery],s-port As [ServerPortUsed],cs-username As ClientUserName,c-ip As [ClientIPAddress],cs(User-Agent) As [ClientBrowserType],sc-status As [HTTPorFTPStatusCode],sc-substatus As [HTTPorFTPSubStatusCode],sc-win32-status As [WindowsStatusCode],time-taken As [RequestDurationInMilliseconds],cs(Referer) As [PreviousSite],TO_LOCALTIME(SYSTEM_TIMESTAMP()) Into IISLog_110Consulting6 From C:\inetpub\logs\LogFiles\W3SVC3\u_ex*.log" -o:SQL -oConnString:"Driver={SQL Server};Server=110Consulting7;Database=IISLog;Trusted_Connection=yes;" -Recurse:-1 

echo ============== End: Archive logs in W3SVC3 folder =======================

echo ============== Start: Archive logs in W3SVC4 folder =======================

LogParser.exe -i:IISw3c "Select Date As [RequestDate],Time As [RequestTimeInUTC],s-ip As [ServerLogsGeneratedOn],cs-method As [RequestActionType],cs-uri-stem As [ActionTarget],cs-uri-query As [RequestQuery],s-port As [ServerPortUsed],cs-username As ClientUserName,c-ip As [ClientIPAddress],cs(User-Agent) As [ClientBrowserType],sc-status As [HTTPorFTPStatusCode],sc-substatus As [HTTPorFTPSubStatusCode],sc-win32-status As [WindowsStatusCode],time-taken As [RequestDurationInMilliseconds],cs(Referer) As [PreviousSite],TO_LOCALTIME(SYSTEM_TIMESTAMP()) Into IISLog_110Consulting6 From C:\inetpub\logs\LogFiles\W3SVC4\u_ex*.log" -o:SQL -oConnString:"Driver={SQL Server};Server=110Consulting7;Database=IISLog;Trusted_Connection=yes;" -Recurse:-1 
