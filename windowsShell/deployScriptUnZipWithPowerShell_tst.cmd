...
echo Executing powershell.exe -NoP -NonI -Command "Expand-Archive '.\part1.zip' '.\ScopeSDK\'" on %date% at %time% ...>> c:\scopeQuery\scope.log
powershell.exe -NoP -NonI -Command "Expand-Archive '.\part1.zip' '.\ScopeSDK\'" ...>> c:\scopeQuery\scope.log
echo Completed execution of powershell.exe -NoP -NonI -Command "Expand-Archive '.\part1.zip' '.\ScopeSDK\'" on %date% at %time% ...>> c:\scopeQuery\scope.log
echo ============== End  scripts =======================
