/*
Drop a linked server only if the linked server exists on the server. 
*/
...
Go
If Exists(Select * From #LinkedServers Where SRV_NAME = 'LinkedAcct_OLD')
Begin
	Execute sp_DropServer LinkedAcct_OLD, droplogins	
End